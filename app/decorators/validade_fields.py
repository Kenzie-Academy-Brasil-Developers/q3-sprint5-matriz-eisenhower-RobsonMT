...
def validate_fields(required_keys: list[str], optional_keys: list[str] or str = False):
    ...
    def decorator(func: Callable):
        ...
        def wrapper(*args, **kwargs):
            ...
            if optional_keys:
                missing_keys = [key for key in set(required_keys).difference(optional_keys) if key not in data.keys()]
